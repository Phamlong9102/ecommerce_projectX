...
import OS01 from '~/images/Store/OrangeSandals/OS01.jpg';
import OS02 from '~/images/Store/OrangeSandals/OS02.jpg';
import OS03 from '~/images/Store/OrangeSandals/OS03.jpg';
import OS04 from '~/images/Store/OrangeSandals/OS04.jpg';
import OS05 from '~/images/Store/OrangeSandals/OS05.jpg';
import OS06 from '~/images/Store/OrangeSandals/OS06.jpg';
      ...
      <>
         ...
         <div className="w-full h-[140px] relative flex justify-center bg-[#f6f6f6] mt-[32px] selection-default">
            <div className="absolute top-[40%] left-[4%] store-menu-route">
               ...
               <span className="mx-[10px]">/</span>
               <Link className="" to="">
                  <span className="">Orange Sandals</span>
               </Link>
            </div>
            <div className="absolute top-[48%] left-[4%] mt-[10px]">
               <span className="store-big-title">Orange Sandals</span>
            </div>
         </div>
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={OS01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OS02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OS03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OS04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OS05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={OS06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Orange Sandals</span>
               </div>
               <div className="flex ">
                  <div className="">
                     <span className="line-through	text-[15px] font-['Poppins'] text-black font-medium leading-[30px]">$125.00</span>
                  </div>
                  <div className="">
                     <span className="text-[18px] font-['Poppins'] font-semibold ml-[12px]">$75.00</span>
                  </div>
               </div>
            ...
            <div className="grid grid-cols-4 gap-4">
               <div className="relative cursor-pointer mx-[8px]">
                  ...
                  <div className="flex justify-between mt-[22px]">
                     <div>
                        <span className="products-name-shopping-everyday">Orange Sandals</span>
                     </div>
                     <div>
