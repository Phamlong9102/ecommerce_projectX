...
import OA01 from '~/images/Store/OrangeAirsuit/OA01.jpg'
import OA02 from '~/images/Store/OrangeAirsuit/OA02.jpg'
import OA03 from '~/images/Store/OrangeAirsuit/OA03.jpg'
import OA04 from '~/images/Store/OrangeAirsuit/OA04.jpg'
import OA05 from '~/images/Store/OrangeAirsuit/OA05.jpg'
import OA06 from '~/images/Store/OrangeAirsuit/OA06.jpg'
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={OA01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OA02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OA03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OA04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OA05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="w-532px h-[721px]" src={OA06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Orange Airsuit</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold ">$225.00</span>
               </div>
