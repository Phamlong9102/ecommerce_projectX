...
import RS01 from '~/images/Store/RedSuit/RS01.jpg';
import RS02 from '~/images/Store/RedSuit/RS02.jpg';
import RS03 from '~/images/Store/RedSuit/RS03.jpg';
import RS04 from '~/images/Store/RedSuit/RS04.jpg';
import RS05 from '~/images/Store/RedSuit/RS05.jpg';
import RS06 from '~/images/Store/RedSuit/RS06.jpg';
      ...
      <>
         ...
         <div className="w-full h-[140px] relative flex justify-center bg-[#f6f6f6] mt-[32px] selection-default">
            ...
            <div className="absolute top-[48%] left-[4%] mt-[10px]">
               <span className="store-big-title">Red Suit</span>
            </div>
         </div>
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={RS01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={RS02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={RS03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={RS04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={RS05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={RS06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Red Suit</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold">$456.00</span>
               </div>
