...
import OW03 from '~/images/Store/OrangeWeil/OW03.jpg';
import OW04 from '~/images/Store/OrangeWeil/OW04.jpg';
import OW05 from '~/images/Store/OrangeWeil/OW05.jpg';
import OW06 from '~/images/Store/OrangeWeil/OW06.jpg';
      ...
      <>
         ...
         <div className="w-full h-[140px] relative flex justify-center bg-[#f6f6f6] mt-[32px] selection-default">
            <div className="absolute top-[40%] left-[4%] store-menu-route">
               ...
               <span className="mx-[10px]">/</span>
               <Link className="" to="">
                  <span className="">Orange Weil</span>
               </Link>
            </div>
            <div className="absolute top-[48%] left-[4%] mt-[10px]">
               <span className="store-big-title">Orange Weil</span>
            </div>
         </div>
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={OW01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OW02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OW03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OW04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={OW05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={OW06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Orange Weil</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold">$60.00</span>
               </div>
