...
import DSB03 from '~/images/Store/DrawstringBag/DSB03.jpg';
import DSB04 from '~/images/Store/DrawstringBag/DSB04.jpg';
import DSB05 from '~/images/Store/DrawstringBag/DSB05.jpg';
import DSB06 from '~/images/Store/DrawstringBag/DSB06.jpg';
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={DSB01} alt="" />
                  </div>
                  ...
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={DSB05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={DSB06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">DrawstringBag</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold">$45.00</span>
               </div>
