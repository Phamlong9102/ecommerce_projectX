...
import GS01 from '~/images/Store/GoldenSandals/GS01.jpg';
import GS02 from '~/images/Store/GoldenSandals/GS02.jpg';
import GS03 from '~/images/Store/GoldenSandals/GS03.jpg';
import GS04 from '~/images/Store/GoldenSandals/GS04.jpg';
import GS05 from '~/images/Store/GoldenSandals/GS05.jpg';
import GS06 from '~/images/Store/GoldenSandals/GS06.jpg';
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={GS01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={GS02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={GS03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={GS04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={GS05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={GS06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Golden Sandals</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold">$115.00</span>
               </div>
