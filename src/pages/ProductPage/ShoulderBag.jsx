...
import SB01 from '~/images/Store/ShoulderBag/SB01.jpg';
import SB02 from '~/images/Store/ShoulderBag/SB02.jpg';
import SB03 from '~/images/Store/ShoulderBag/SB03.jpg';
import SB04 from '~/images/Store/ShoulderBag/SB04.jpg';
import SB05 from '~/images/Store/ShoulderBag/SB05.jpg';
import SB06 from '~/images/Store/ShoulderBag/SB06.jpg';
      ...
      <>
         ...
         <div className="w-full h-[140px] relative flex justify-center bg-[#f6f6f6] mt-[32px] selection-default">
            <div className="absolute top-[40%] left-[4%] store-menu-route">
               ...
               <span className="mx-[10px]">/</span>
               <Link className="" to="">
                  <span className="">ShoulderBag</span>
               </Link>
            </div>
         ...
         <div className="mt-[80px] flex justify-center selection-default">
            <div className="flex justify-center">
               <div className="flex flex-col ">
                  <div className="">
                     <img className="w-[112px] h-[136px]" src={SB01} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={SB02} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={SB03} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={SB04} alt="" />
                  </div>
                  <div className="mt-[10px]">
                     <img className="w-[112px] h-[136px]" src={SB05} alt="" />
                  </div>
               </div>
               <div className=" ml-[10px]">
                  <img className="relative w-532px h-[721px] " src={SB06} alt="" />
               </div>
            </div>
            <div className="ml-[54px] flex flex-col">
               <div className="mb-[4px]">
                  <span className="font-['Poppins'] font-semibold	text-[36px]">Shoulder Bag</span>
               </div>
               <div className="">
                  <span className="text-[18px] font-['Poppins'] font-semibold">$90.00</span>
               </div>
               ...
               <div className="flex flex-col mt-[64px] text-[10px] uppercase font-medium tracking-[0.29em] text-[##3d3d3d] font-['Montserrat'] leading-[26px]">
                  <div>
                     <span className="">Sku: 036</span>
                  </div>
                  <div className="">
                     <span className="">Category: Bags</span>
                  </div>
                  <div className="">
                     <span className="">Tags: lifestyle</span>
                  </div>
               </div>
            </div>
         </div>
